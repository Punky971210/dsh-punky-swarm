...
- **Tool 6 attributes (P7)**: toolId / name / description / version / inputParam / outputParam per tool (toolId = `dsh.punky-swarm.<name>`; inputParam/outputParam are JSON Schema with required always present);
